...
//                 alt="Jonathan Croco Properties Preview"
//                 fill
...
//                 {/* Email */}
//                 <a
//                   href="mailto:Jonathan Croco@Jonathan CrocoConsultant.ca"
//                   onClick={(e) => e.stopPropagation()}
...
const DEFAULT_NAV_LINKS = [
  { label: "Home", href: "/", icon: Home },
  { label: "About", href: "/about", icon: User },
  { label: "Testimonials", href: "/testimonials", icon: Building2 }, // <-- UNCOMMENTED
  { label: "Blogs", href: "/blogs", icon: BookOpen },
];
  ...
  return (
    <>
      ...
      <div
        ...
        className="hidden md:flex fixed top-25 left-0 right-0 z-999 justify-center px-4 lg:px-8"
      >
        <div className="w-full max-w-3xl bg-white rounded-2xl overflow-hidden shadow-2xl border border-black/10">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-0">
            {/* Left: Hero Preview Image */}
            <div className="relative h-44 lg:h-auto lg:min-h-70">
              <Image
                  ...
                  <div className="flex flex-col gap-1.5">
                    {DEFAULT_NAV_LINKS.map((link, index) => (
                      <Link
                        ...
                        href={link.href}
                        onClick={handleLinkClick}
                        className="group relative py-1.5 text-black hover:opacity-70 transition-all text-sm font-medium"
                      >
                        <span className="relative">
                          {link.label}
          ...
          {/* Bottom Section */}
          <div className="border-t border-black/10 p-4 flex items-center justify-between gap-3 bg-[#F4F4F5]">
            <a
              href="mailto:chris@margenau.com"
              className="flex items-center gap-2 text-black hover:opacity-70 transition-all"
            >
              <Mail size={15} />
              <span className="text-sm font-medium">
            ...
            <div className="flex items-center gap-2">
              ...
              <Link
                ...
                className={`flex items-center gap-1.5 px-3 py-2 text-sm font-semibold rounded-lg transition-colors ${
                  isLoggedIn
                    ? "bg-black/10 border border-black/30 text-black hover:bg-black/20 hover:border-black/50"
                    : "bg-[#F4F4F5] border border-black/20 text-black hover:bg-black/10 hover:border-black/40"
                }`}
              >
                {(() => {
                  const AdminIcon = adminLinkConfig.icon;
              ...
              <Link
                href="/properties"
                onClick={handleLinkClick}
                className="px-4 py-2 bg-black text-white text-sm font-semibold rounded-lg hover:bg-[#333333] transition-colors"
              >
                All Properties
              </Link>
              <button
                onClick={handleClose}
                className="w-9 h-9 flex items-center justify-center bg-black text-white rounded-lg hover:bg-[#333333] transition-colors"
              >
                <ArrowRight size={16} />
              </button>
            </div>
          ...
          <>
            ...
            >
              ...
              <motion.button
                ...
                transition={{ delay: 0.2, type: "spring" }}
                onClick={handleClose}
                className="absolute top-3 right-3 z-50 w-9 h-9 flex items-center justify-center rounded-full bg-black text-white hover:bg-[#333333] transition-colors shadow-lg"
              >
                <X size={18} />
              </motion.button>
              ...
              <div className="flex-1 px-4 py-4 overflow-y-auto">
                {/* Main Pages */}
                <div className="mb-3">
                  <h3 className="text-black/70 text-[10px] font-bold tracking-[0.2em] uppercase mb-2">
                    Main Pages
                  </h3>
                  <div className="flex flex-col gap-1">
                    {DEFAULT_NAV_LINKS.map((link, index) => {
                      ...
                      return (
                        <Link
                          ...
                          href={link.href}
                          onClick={handleLinkClick}
                          className="group flex items-center gap-3 px-3 py-3 rounded-xl hover:bg-[#F4F4F5] active:bg-[#F4F4F5]/70 transition-all duration-200"
                        >
                          <div className="w-9 h-9 rounded-lg bg-[#F4F4F5] group-hover:bg-black flex items-center justify-center transition-all duration-200">
                            <Icon
                              size={16}
                              className="text-black group-hover:text-white transition-colors duration-200"
                            />
                          </div>
                          <span className="text-black group-hover:opacity-70 font-medium text-sm transition-all duration-200">
                            {link.label}
                          </span>
                        </Link>
                      );
              ...
              {/* Bottom Section */}
              <div className="border-t border-black/10 px-4 py-4 shrink-0 bg-[#F4F4F5]">
                {/* Email */}
                <a
                  href="mailto:Jonathan Croco@Jonathan CrocoConsultant.ca"
                  onClick={(e) => e.stopPropagation()}
                  className="flex items-center justify-center gap-1.5 text-black hover:opacity-70 transition-all mb-3"
                >
                  <Mail size={12} />
                  <span className="text-[11px] font-medium">
                    chris@margenau.com
                ...
                <div className="flex flex-col items-center gap-2">
                  ...
                  <Link
                    ...
                    className={`w-full flex items-center justify-center gap-2 px-4 py-2.5 text-sm font-semibold rounded-xl transition-all duration-200 ${
                      isLoggedIn
                        ? "bg-black/10 border border-black/30 text-black hover:bg-black/20 active:bg-black/30"
                        : "bg-white border border-black/20 text-black hover:bg-black/10 active:bg-black/20"
                    }`}
                  >
                    {(() => {
                      const AdminIcon = adminLinkConfig.icon;
                  ...
                  <Link
                    href="/properties"
                    onClick={handleLinkClick}
                    className="w-full flex items-center justify-center gap-2 px-4 py-2.5 bg-black text-white text-sm font-semibold rounded-xl hover:bg-[#333333] active:bg-[#333333] transition-all duration-200"
                  >
                    <FileText size={16} />
                    <span>All Properties</span>
                  </Link>
