...
//       "Current  Baltimore Metro,market insights",
...
const TEAL = DARK_GRAY;      // Accent color for icons, lines, small text
const MINT = LIGHT_GRAY;     // For subtle background tints
...
export default function ServicesPage() {
  ...
  return (
    ...
    >
          ...
          <div className="max-w-3xl mx-auto">
            <div className="hero-line flex items-center justify-center gap-3 mb-6 origin-left">
              ...
              <div
                className="w-8 h-px"
                style={{
                  background: `linear-gradient(to left, ${PURE_WHITE}, transparent)`,
                }}
              />
            </div>

            <h1 className="hero-title text-4xl sm:text-5xl lg:text-6xl text-white tracking-tight leading-[1.1] mb-6 font-bold">
              Our <span style={{ color: PURE_WHITE }}>Services</span>
            </h1>

            <p
              className="hero-sub text-lg sm:text-xl leading-relaxed max-w-2xl mx-auto"
              style={{ color: `${PURE_WHITE}B3` }}
            >
              Comprehensive real estate solutions tailored to your needs. From
              finding your dream home to maximizing your investment returns.
            </p>
              ...
              return (
                <div
                  ...
                  style={{
                    ...
                    boxShadow: `0 10px 30px -10px ${BLACK}10`,
                  }}
                  onMouseEnter={(e) => {
                    e.currentTarget.style.borderColor = `${TEAL}40`;
                    e.currentTarget.style.boxShadow = `0 20px 40px -15px ${BLACK}20`;
                  }}
                  onMouseLeave={(e) => {
                    e.currentTarget.style.borderColor = `${BLACK}10`;
                    e.currentTarget.style.boxShadow = `0 10px 30px -10px ${BLACK}10`;
                  }}
                >
                  {/* Subtle glow */}
                  <div
                    className="absolute top-0 right-0 w-40 h-40 rounded-full blur-3xl -translate-y-1/2 translate-x-1/2 opacity-0 group-hover:opacity-10 transition-opacity duration-700 pointer-events-none"
                  ...
                  <h3 className="relative text-xl text-black mb-3 leading-tight font-semibold">
                    {service.title}
                  </h3>
                  ...
                  <div
                    className="relative mt-7 pt-5"
                    style={{ borderTop: `1px solid ${BLACK}10` }}
                  >
                    <Link
                      href="/contact"
                      className="inline-flex items-center gap-2 text-sm font-semibold transition-all duration-300 group/link"
      ...
      {/* ===== GUIDES DOWNLOAD SECTION ===== */}
      <div ref={guidesRef} className="relative z-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pb-24">
          <div className="text-center mb-14">
            <div className="flex items-center justify-center gap-3 mb-5">
              <div
            ...
            <h2 className="text-3xl sm:text-4xl text-black tracking-tight leading-[1.1] mb-4 font-bold">
              Download Our <span style={{ color: TEAL }}>Free Guides</span>
            </h2>
            ...
            {guides.map((guide) => {
              ...
              return (
                ...
                >
                  {/* Subtle glow */}
                  <div
                    className="absolute top-0 right-0 w-32 h-32 rounded-full blur-3xl -translate-y-1/2 translate-x-1/2 opacity-0 group-hover:opacity-10 transition-opacity duration-700 pointer-events-none"
                    style={{ backgroundColor: BLACK }}
                  />
                  ...
                  <div className="relative p-7 sm:p-8">
                    ...
                    <h3 className="text-xl text-black mb-2 font-semibold">
                      {guide.title}
                    </h3>
                    <p
                      className="text-sm leading-relaxed mb-5"
