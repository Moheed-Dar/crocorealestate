...
const testimonials = [
  ...
  { id: 4, name: "Josh & Meghan", text: "When buying your first home Jonathan Croco is the realtor best suited for the job. Jonathan Croco gets to know her clients and is able to pick out homes that will suit you best. She really knows the areas of  Baltimore Metro,well and is flexible with her time in order to book viewings when it suits you best. She is knowledgeable and we were able to understand the process of buying a home with her expertise. You'd be mistaken to not use Jonathan Croco for your future home buying needs!" },
  { id: 5, name: "Nicole Schenk", text: "I've had the pleasure of working with Jonathan Croco for a few years, and I am consistently impressed by her dedication to her clients. Jonathan Croco excels in providing a seamless experience for both sellers and buyers, ensuring that every transaction is smooth and stress-free. She takes the time to listen to her clients' needs and preferences, offering personalized and reliable service that is second to none. Her extensive knowledge of the  Baltimore Metro,real estate market is truly impressive, and it is clear that she is passionate about helping her clients achieve their goals. Jonathan Croco is a true professional, and I highly recommend her to anyone looking to buy or sell property in the  Baltimore Metro,." },
